...
public class CustomerRegistration extends JFrame {
	...
	public CustomerRegistration() {
		...
		registerButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(tncCheckBox.isSelected()) {
					JOptionPane.showMessageDialog(null, "Registration Successful!", "Welcome! " + usernameText.getText(), JOptionPane.INFORMATION_MESSAGE);
		...
		backButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (JOptionPane.showConfirmDialog(null, "Are you sure to return to login page?", "Cancellation", 
