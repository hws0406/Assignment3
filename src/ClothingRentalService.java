...
public class ClothingRentalService extends JFrame{
	...
	public ClothingRentalService() {
		...
		Image img1 = new ImageIcon(this.getClass().getResource("clothing3.jpg")).getImage();
	    backgroundLabel.setIcon(new ImageIcon(img1));
		backgroundLabel.setBounds(0, 0, 806, 583);
